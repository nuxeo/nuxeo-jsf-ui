...
public class SeamSnapshotManagerComponent extends SnapshotManagerComponent implements SeamSnapshotManager {

    @Override
    public void initSeamContext(HttpServletRequest request) {
        ((SeamRuntimeSnapshot) getRuntimeSnapshot()).initSeamComponents(request);
    }
